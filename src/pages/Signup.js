...
function Signup() {
  ...
  return (
    <div className='bg-slate-800 w-screen h-screen flex flex-row '>
            <LoadingBar color='Yellow' ref={ref}  ></LoadingBar>

      <div className='left  w-2/5  h-screen '>
        <h1 className='text-white font-thin  w-3/4 pl-10 text-7xl leading-tight relative top-1/4 left-10 whitespace-pre-wrap ' ><span className='font-medium text-orange-500' >PERSONAL</span><br></br>FINANCE CHECKER WEB !!</h1>
      </div>
      ...
      <div className='flex justify-center items-center  w-3/5 h-screen '>
        <div className='flex flex-col gap-7 w-3/5 h-2/3 pt-20 items-center'>
          ...
          <p className='text-white text-lg -mt-4' > Already Registred!! <a href=' /login' className='underline'><b>  Login</b></a></p>
        </div>
      </div>
    </div>
  )
